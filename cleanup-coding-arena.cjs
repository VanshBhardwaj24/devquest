...
// Remove any async/await patterns that might cause issues with localStorage
...
console.log(`File size: ${originalSize} bytes → ${newSize} bytes (reduced by ${originalSize - newSize} bytes)`);
