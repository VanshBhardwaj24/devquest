...
interface CodingProblem {
  ...
  streak?: number;
  description?: string;
  category: 'Array' | 'String' | 'Tree' | 'Graph' | 'DP' | 'Math' | 'LinkedList' | 'Heap' | 'Stack' | 'Design' | 'SQL' | 'Intervals' | 'Trie' | 'Bit Manipulation' | 'Sliding Window' | 'Greedy' | 'Recursion' | 'Backtracking' | 'Sorting' | 'Search' | 'Queue' | 'Unknown';
